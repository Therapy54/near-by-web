...
import { getAuth, signInWithEmailAndPassword, createUserWithEmailAndPassword, signOut, onAuthStateChanged, GoogleAuthProvider, signInWithPopup, connectAuthEmulator, sendPasswordResetEmail } from 'firebase/auth';
